          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link to="/forgot-password" className="font-medium text-accent-600 hover:text-accent-500 transition-colors duration-200">
                  Mot de passe oublié ?
                </Link>
              </div>
            </div>
            ...
            <div className="text-center">
              <p className="text-sm text-primary-600">
                ...
                <Link to="/register" className="font-medium text-accent-600 hover:text-accent-500 transition-colors duration-200">
                  Créer un compte
                </Link>
              </p>
            </div>
